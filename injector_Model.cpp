...
{
    //**********INPUT PARAMETERS**********
    //**********(Note, if upstream pressure is an input (ie for superpressurized NOS), P1 must be changed)
    //********** keep in mind that these input values must be callable by the NIST table (ie Pressure must be divisible by 10 since the NIST table was made with increments of 10)
    //T1: NOS tank temp, degrees C
    //P2F in psi: absolute Combustion Chamber pressure
    //**********INJECTOR GEOMETRY**********
